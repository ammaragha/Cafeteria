...
$Message=[];
        ...
        if (count($Message) == 0) {
            $sql = "update user set name='$name' , email='$email' , phone= '$phone' , role_id = $role_id , image ='$FinalName' ,room='$room' where id = $id";
    ...
    echo 'selected';
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName" name="room" aria-describedby=""
                            placeholder="Enter room"  value="<?php echo $UserData['room']; ?>">
                    </div> 
